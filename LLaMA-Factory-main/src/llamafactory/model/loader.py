...
def load_model(
    ...
    #     param.requires_grad = True if name in trainable_params else False
    # # 训练前检查
    # print("可训练参数清单：")
    # for name, param in model.named_parameters():
    ...
    ##################第二阶段 视觉编码器冻结 只训练merger、LLM######
    # # 注意：以下代码会覆盖LoRA的参数设置，导致可训练参数为0！
    # # 如果需要使用LoRA，请注释掉这段代码
    ...
    # # 然后解冻需要训练的部分
    # for name, param in model.named_parameters():
    #     # 解冻LLM部分（包括embed_tokens/layers/norm/lm_head）
    #     if name.startswith('model'): 
    #         param.requires_grad = True
    #     # 解冻visual.merger部分
    #     elif name.startswith('visual.merger'):
    #         param.requires_grad = True
    #     # 训练前检查
    # print("可训练参数清单：")
    # for name, param in model.named_parameters():
