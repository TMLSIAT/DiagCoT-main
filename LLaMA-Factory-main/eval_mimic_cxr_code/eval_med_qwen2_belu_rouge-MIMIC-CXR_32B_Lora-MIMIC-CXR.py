...
#         print(f"Loaded Qwen2.5-VL model from {model_path}")
...
#         with torch.no_grad():
#             outputs = self.model.generate(**inputs, max_new_tokens=2048, temperature=0.3, do_sample=True, top_p=0.9) # temperature=0.1,do_sample=True 要同时开
...
def main(test_path, model_path, output_path="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result/Qwen2.5-VL-32B-MIMIC-CXR-Lora_only_F-I.json"):
    # 初始化生成器
    lora_path = "/data0/zhuoxu/yihong/code/LLaMA-Factory-main/saves/Qwen2.5-VL-7B-Instruct/lora/tran_Qwen2.5_vl_32B_lora"
...
if __name__ == "__main__":
    main(
        ...
        model_path="/data0/zhuoxu/yihong/code/Qwen2.5-VL-32B-Instruct"
