...
class ReportGenerator:
    ...
    def generate(self, image_path):
        ...
        with torch.no_grad():
            outputs = self.model.generate(**inputs, max_new_tokens=2048,use_cache=True) # temperature=0.1,do_sample=True 要同时开 ,   temperature=0.3, do_sample=True,top_p=0.9 | use_cache=True RFT的方法要用
...
def main(test_path, model_path, output_path): #Qwen2-VL-7B-MIMIC-CXR-Stage2_merger_llm_use_32B_CoT_new_cutoff_wo_think_temp1_5000_1_only_train_llm
...
if __name__ == "__main__":
    main(
        ...
        model_path= "/data0/zhuoxu/yihong/code/EasyR1-main/checkpoints_report_kl_beta_ablation_task2/easy_r1/global_step_400/actor/huggingface",
        output_path = "/data0/zhuoxu/yihong/code/LLaMA-Factory-main/Ablation_eval_result/Ablation_task2_step400_alter_kl_beta_5e-2.json"  #="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result/Qwen2-VL-7B-MIMIC-CXR-Stage3_merger_llm_use_32B_10000_CoT_new_cutoff_wo_think_temp1_RFT_verl_step400_alter_kl_beta_5e-2.json"
    )