...
if __name__ == "__main__":
    main(
        ...
        model_path="/data0/zhuoxu/yihong/code/EasyR1-main/checkpoints_report_kl_beta_add_repetition_penalty/easy_r1/global_step_400/actor/huggingface" #step 200的模型已经移到：/data0/zhuoxu/yihong/code/EasyR1-main/checkpoint_hug/huggingface  (Step 200)
    )