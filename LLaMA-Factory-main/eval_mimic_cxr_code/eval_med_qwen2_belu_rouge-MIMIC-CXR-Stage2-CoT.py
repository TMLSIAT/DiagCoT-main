...
if __name__ == "__main__":
    main(
        ...
        output_path="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result/Qwen2-VL-7B-MIMIC-CXR-Stage2_merger_llm_use_32B_CoT_new_cutoff_wo_think_temp1_10000_1e-5_epoch2.json"
    )