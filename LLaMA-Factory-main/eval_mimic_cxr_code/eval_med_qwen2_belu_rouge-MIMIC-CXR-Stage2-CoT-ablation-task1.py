...
class ReportGenerator:
    ...
    def generate(self, image_path):
        ...
        with torch.no_grad():
            outputs = self.model.generate(**inputs, max_new_tokens=12000) # temperature=0.1,do_sample=True 要同时开 ,   temperature=0.3, do_sample=True,top_p=0.9 | use_cache=True RFT的方法要用
...
if __name__ == "__main__":
    main(
        ...
        model_path="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/saves/Qwen2-VL-7B-Instruct/full/Ablation_train_direct_cot_stage2_merger_llm_1e-5_ep2",
        output_path="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/Ablation_eval_result/Ablation_train_direct_cot_stage2_merger_llm_1e-5_ep2.json"
    )