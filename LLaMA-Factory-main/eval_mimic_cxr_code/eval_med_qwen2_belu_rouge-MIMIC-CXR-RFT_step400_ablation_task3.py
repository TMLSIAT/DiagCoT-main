...
if __name__ == "__main__":
    main(
        ...
        model_path= "/data0/zhuoxu/yihong/code/EasyR1-main/checkpoints_report_kl_beta_ablation_task3/easy_r1/global_step_400/actor/huggingface",
        output_path = "/data0/zhuoxu/yihong/code/LLaMA-Factory-main/Ablation_eval_result/Ablation_task3_step400_alter_kl_beta_5e-2.json" 
    )