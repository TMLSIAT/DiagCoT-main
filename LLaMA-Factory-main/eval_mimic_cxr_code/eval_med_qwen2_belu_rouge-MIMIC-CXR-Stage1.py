...
class ReportGenerator:
    ...
    def generate(self, image_path):
        ...
        with torch.no_grad():
            outputs = self.model.generate(**inputs, max_new_tokens=4096) # temperature=0.1,do_sample=True 要同时开 ,   temperature=0.3, do_sample=True,top_p=0.9 | use_cache=True RFT的方法要用
...
def main(test_path, model_path, output_path="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result/Qwen2-VL-7B-MIMIC-CXR-Stage1_merger_llm_wo_think_temp1_latest.json"): #Qwen2-VL-7B-MIMIC-CXR-Stage2_merger_llm_use_32B_CoT_new_cutoff_wo_think_temp1_5000_1_only_train_llm
