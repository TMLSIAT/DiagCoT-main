...
def main():
    ...
    parser.add_argument("--model_path", type=str, 
                       default="/data0/zhuoxu/yihong/code/Qwen2-VL-7B-Instruct",
                       help="训练好的模型路径")
    parser.add_argument("--test_data", type=str, 
                       default="/data0/zhuoxu/yihong/code/EasyR1-main/eval_data/test_grounding_balanced.json",
                       help="测试数据文件路径")
    parser.add_argument("--output_dir", type=str, 
                       default="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/task_grounding_result_all/task_grounding_result_test_balanced_improved_baseline",
                       help="评估结果输出目录")
