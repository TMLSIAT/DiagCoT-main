...
def parse_prediction_text_improved(text: str) -> Tuple[List[Tuple[float, float, float, float]], bool]:
    ...
    # 首先提取answer标签内的内容
    answer_text = extract_answer_from_tags(text)
    print("prediction_answer_text:",answer_text)
    # 检查是否明确表示没有检测到异常
    no_finding_patterns = [
...
def main():
    ...
    parser.add_argument("--model_path", type=str, 
                       default="/data0/zhuoxu/yihong/code/EasyR1-main/checkpoints_grounding_3_use_cotdata_and_after_merger_llm_train_new_new_reward/easy_r1/global_step_1000/actor/huggingface",
                       help="训练好的模型路径")
    parser.add_argument("--test_data", type=str, 
                       default="/data0/zhuoxu/yihong/code/EasyR1-main/eval_data/test_grounding_balanced.json",
                       help="测试数据文件路径")
    parser.add_argument("--output_dir", type=str, 
                       default="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/task_grounding_result_test_balanced_improved_test_cotdata_and_after_merger_llm_train_rft_1000_new_new_reward",
                       help="评估结果输出目录")
