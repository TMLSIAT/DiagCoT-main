...
if __name__ == "__main__":
    main(
        ...
        model_path= "/data0/zhuoxu/yihong/code/EasyR1-main/checkpoints_report_kl_beta_add_repetition_penalty/easy_r1/global_step_200/actor/huggingface",
        output_path="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result/Qwen2-VL-7B-IU-Xray-Stage3_merger_llm_use_32B_10000_CoT_new_cutoff_wo_think_temp1_RFT_verl_step200_alter_kl_beta_5e-2_add_repetition_penalty.json"
    )