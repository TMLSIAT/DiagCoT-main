...
if __name__ == "__main__":
    ...
    MODEL_NAME = "/data0/zhuoxu/yihong/code/Test_CoT_Med_MLLM/Qwen2.5-vl-32B-merger-lora-base"  # 根据实际部署的模型名称调整
    API_URL = "http://127.0.0.1:8000/v1"  # VLLM服务地址
    OUTPUT_PATH = "/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result/Qwen2.5-VL-32B-LoRA-IU-xray.json"
