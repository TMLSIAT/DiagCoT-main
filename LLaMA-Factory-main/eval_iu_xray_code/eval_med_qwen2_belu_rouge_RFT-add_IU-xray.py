...
# 确保NLTK资源就绪
'''
IU-xray 的测试  在Stage3 RFT后的模型进行微调 添加IU-Xray的数据进来
'''
try:
...
class ReportGenerator:
    ...
    def generate(self, image_path):
        ...
        with torch.no_grad():
            outputs = self.model.generate(**inputs, max_new_tokens=1024,use_cache=True) # temperature=0.1,do_sample=True 要同时开  use_cache=True
...
if __name__ == "__main__":
    main(
        ...
        model_path="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/saves/Qwen2-VL-7B-Instruct/lora/train_med_lora_use_iu_xray_percent20_after_stage3_RFT400/merger_model",
        output_path="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result_stage3_add_iu_xray/train_med_lora_use_iu_xray_percent20_after_stage3_RFT400.json"
    )