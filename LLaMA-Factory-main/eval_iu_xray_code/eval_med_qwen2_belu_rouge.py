...
class ReportGenerator:
    ...
    def generate(self, image_path):
        ...
        with torch.no_grad():
            outputs = self.model.generate(**inputs, max_new_tokens=12000) 
...
if __name__ == "__main__":
    main(
        ...
        output_path="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result_filter/Qwen2-VL-7B-Stage2-train-merger-llm-IU-xray-bleu-rouge-wo-think-pormpt-temp1_10000_1e-5_epoch2_filter_rft_num624.json"
    )