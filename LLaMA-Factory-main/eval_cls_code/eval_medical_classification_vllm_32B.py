...
def main():
    ...
    主函数
    """
    parser = argparse.ArgumentParser(description='使用VLLM评估医疗分类模型 - 32B版本')
    ...
    parser.add_argument('--output_file', type=str, 
                       default='/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result/Qwen2.5-VL-32B-VLLM-CLS.json', 
                       help='输出结果文件路径')
...
if __name__ == "__main__":
    # 配置参数
    TEST_FILE = "/data0/zhuoxu/yihong/code/EasyR1-main/eval_cls_code/eval_data/test_cls_qwen.json"
    MODEL_NAME = "/data0/zhuoxu/yihong/code/Qwen2.5-VL-32B-Instruct"  # 根据实际部署的模型名称调整
    API_URL = "http://127.0.0.1:8000/v1"  # VLLM服务地址
    OUTPUT_FILE = "/data0/zhuoxu/yihong/code/LLaMA-Factory-main/eval_result/Qwen2.5-VL-32B-VLLM-CLS.json"
