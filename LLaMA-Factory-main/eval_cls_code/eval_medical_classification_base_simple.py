...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/data0/zhuoxu/yihong/code/LLaMA-Factory-main/saves/Qwen2-VL-7B-Instruct/full/train_Stage2_use_32B_MIMIC_CXR_10000_1_train_merger_llm_1e-5_epoch2', help='模型路径')
    parser.add_argument('--test_file', type=str, default='eval_data/test_cls_qwen.json', help='测试文件路径')
    parser.add_argument('--output_file', type=str, default="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/task_cls_result/base_cls_qwen_simple.json", help='输出结果文件路径')
