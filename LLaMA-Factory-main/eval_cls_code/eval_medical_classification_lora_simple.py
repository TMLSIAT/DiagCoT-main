...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/data0/zhuoxu/yihong/code/EasyR1-main/Stage2_chxpert_lora_cls_model_w_system/merged_model', help='模型路径')
    parser.add_argument('--test_file', type=str, default='eval_data/test_cls_qwen.json', help='测试文件路径')
    parser.add_argument('--output_file', type=str, default="/data0/zhuoxu/yihong/code/LLaMA-Factory-main/task_cls_result/lora_cls_qwen_simple.json", help='输出结果文件路径')
