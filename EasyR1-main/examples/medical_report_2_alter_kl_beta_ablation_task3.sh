...
CUDA_VISIBLE_DEVICES=2,3 python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=examples/reward_function/medical_report_only_use_abltion_task3.py:compute_score \
    ...
    trainer.save_checkpoint_path=${EASYR1_DIR}/checkpoints_report_kl_beta_ablation_task3/easy_r1 \
