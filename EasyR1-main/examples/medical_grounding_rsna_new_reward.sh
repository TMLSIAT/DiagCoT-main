...
CUDA_VISIBLE_DEVICES=2,3 python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=examples/reward_function/improved_medical_grounding_reward.py:compute_score \
    ...
    trainer.save_checkpoint_path=${EASYR1_DIR}/checkpoints_grounding_3_use_cotdata_and_after_merger_llm_train_new_new_reward/easy_r1 \
