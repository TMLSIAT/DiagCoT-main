...
CUDA_VISIBLE_DEVICES=2,3 python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=examples/reward_function/medical_report_add_repetition_penalty.py:compute_score \
    ...
    trainer.save_checkpoint_path=${EASYR1_DIR}/checkpoints_report_kl_beta_add_repetition_penalty/easy_r1 \
