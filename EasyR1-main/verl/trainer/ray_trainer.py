...
from ..utils.model_utils import get_signal, write_jsonl
...
class RayPPOTrainer:
    ...
    def fit(self):
        ...
        if self.config.trainer.save_freq <= 0 or self.global_step % self.config.trainer.save_freq != 0:
            ...
            signals = get_signal('/data0/zhuoxu/yihong/code/EasyR1-main/signal_dir')
            if 'is_model_save' in signals:
                self._save_checkpoint()
                os.remove(os.path.join('/data0/zhuoxu/yihong/code/EasyR1-main/signal_dir', "is_model_save"))  # 清理信号